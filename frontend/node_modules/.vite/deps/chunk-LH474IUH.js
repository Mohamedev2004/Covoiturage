...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      var React26 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore2 = shim.useSyncExternalStore, useRef17 = React26.useRef, useEffect9 = React26.useEffect, useMemo16 = React26.useMemo, useDebugValue2 = React26.useDebugValue;
...
function FloatingFocusManager(props) {
  ...
  React6.useEffect(() => {
    ...
    function onPointerDown(event) {
      ...
      const pointerTargetInside = contains(floating, target) || contains(domReference, target) || contains(portalContext == null ? void 0 : portalContext.portalNode, target);
  ...
  React6.useEffect(() => {
    ...
    function handleFocusOutside(event) {
      ...
      queueMicrotask(() => {
        ...
        const movedToUnrelatedNode = !(contains(domReference, relatedTarget) || contains(floating, relatedTarget) || contains(relatedTarget, floating) || contains(portalContext == null ? void 0 : portalContext.portalNode, relatedTarget) || relatedTarget != null && triggers.hasElement(relatedTarget) || triggers.hasMatchingElement((trigger) => contains(trigger, relatedTarget)) || isRelatedFocusGuard || tree && (getNodeChildren(tree.nodesRef.current, nodeId).find((node) => {
          var _a, _b;
  ...
  React6.useEffect(() => {
    ...
    const insideElements = [floating, rootAncestorComboboxDomReference, ...portalNodes, startDismissButtonRef.current, endDismissButtonRef.current, beforeGuardRef.current, afterGuardRef.current, portalContext == null ? void 0 : portalContext.beforeOutsideRef.current, portalContext == null ? void 0 : portalContext.afterOutsideRef.current, resolveRef(previousFocusableElement), resolveRef(nextFocusableElement), isUntrappedTypeableCombobox ? domReference : null].filter((x) => x != null);
...
function useHoverFloatingInteraction(context, parameters = {}) {
  ...
  const closeWithDelay = React18.useCallback((event, runElseBranch = true) => {
    ...
    if (closeDelay && !instance.handler) {
      instance.openChangeTimeout.start(closeDelay, () => store.setOpen(false, createChangeEventDetails(reason_parts_exports.triggerHover, event)));
  ...
  React18.useEffect(() => {
    ...
    function onFloatingMouseEnter(event) {
      ...
      instance.openChangeTimeout.clear();
      clearPointerEvents();
      (_a = instance.handler) == null ? void 0 : _a.call(instance, event);
      cleanupMouseMoveHandler();
    }
...
function useHoverReferenceInteraction(context, props = {}) {
  ...
  const closeWithDelay = React19.useCallback((event, runElseBranch = true) => {
  ...
  const handleScrollMouseLeave = useStableCallback((event) => {
    ...
    (_a2 = handleCloseRef.current) == null ? void 0 : _a2.call(handleCloseRef, {
  ...
  const item = React21.useMemo(() => {
    ...
    const itemProps = {
      ...
      onPointerLeave(event) {
        ...
        onNavigate(event);
        if (!virtual) {
          (_a = floatingFocusElementRef.current) == null ? void 0 : _a.focus({
            preventScroll: true
          });
        }
      }
...
function useRole(context, props = {}) {
  ...
  const floatingId = React22.useMemo(() => {
    var _a;
...
function useTypeahead(context, props) {
  ...
  const onKeyDown = useStableCallback((event) => {
    function getMatchingIndex(list, orderedList, string) {
      const str = orderedList.find((text) => (text == null ? void 0 : text.toLocaleLowerCase().indexOf(string.toLocaleLowerCase())) === 0);
...
use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-LH474IUH.js.map
