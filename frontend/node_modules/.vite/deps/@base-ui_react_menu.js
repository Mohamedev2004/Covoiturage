...
} from "./chunk-IZZD4GGW.js";
import {
  getDisabledMountTransitionStyles,
  useAnchorPositioning,
  useDirection
} from "./chunk-NSZBPJX4.js";
import {
  Separator
} from "./chunk-ADJOBYQY.js";
import {
  COMPOSITE_KEYS,
  InternalBackdrop,
  useOpenInteractionType,
  useScrollLock
} from "./chunk-5IXY43V2.js";
import {
  ...
  useTypeahead
} from "./chunk-LH474IUH.js";
import "./chunk-GL7YRBYQ.js";
import {
  useButton,
  useCompositeRootContext
} from "./chunk-MAYRZ3ME.js";
import {
  useControlled
...
var MenuPositioner = React19.forwardRef(function MenuPositioner2(componentProps, forwardedRef) {
  ...
  const positionerProps = React19.useMemo(() => {
    const hiddenStyles = {};
    if (!open) {
...
function useMixedToggleClickHandler(params) {
  ...
  const ignoreClickRef = React31.useRef(false);
...
var MenuTrigger = fastComponentRef(function MenuTrigger2(componentProps, forwardedRef) {
  ...
  const floatingTreeRoot = React32.useMemo(() => {
  ...
  const preFocusGuardRef = React32.useRef(null);
  ...
  if (isOpenedByThisTrigger) {
    return (0, import_jsx_runtime10.jsxs)(React32.Fragment, {
      ...
      }, `${thisTriggerId}-pre-focus-guard`), (0, import_jsx_runtime10.jsx)(React32.Fragment, {
        children: element
  ...
  return (0, import_jsx_runtime10.jsx)(React32.Fragment, {
    children: element
  }, thisTriggerId);
});
...
function useStickIfOpen(open, openReason) {
  ...
  const [stickIfOpen, setStickIfOpen] = React32.useState(false);
  useIsoLayoutEffect(() => {
